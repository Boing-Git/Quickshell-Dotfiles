...
- **Physics-Based Animations**: Uses custom `PhysicsString` dynamics to provide natural, fluid motion across UI elements rather than linear transitions.
...
| `PhysicsString.qml` | Shared UI utility for robust physics-based spring animations. |
